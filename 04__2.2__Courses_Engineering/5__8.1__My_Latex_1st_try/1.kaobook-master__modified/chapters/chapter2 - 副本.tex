...
\marginnote[-21.5pt]{
	\begin{kaobox}[frametitle=麦氏方程组的微分形式]
...
\begin{theorem}[Mathematics - 实数 \& 复数形式的傅里叶级数]
	\begin{equation}\small
		\begin{split}
				g(x) &= {a_0} + \sum\limits_{i = 1}^\infty  {\left[ {{a_i}\cos \left( {\frac{{2\pi }}{L}i \cdot x} \right) + {b_i}\sin \left( {\frac{{2\pi }}{L}i \cdot x} \right)} \right]} \left( {a,b \in \mathbb{R} } \right) \\
				&= \sum\limits_{i =  - \infty }^\infty  {{c_i}{e^{i\frac{{2\pi }}{L}i \cdot x}}} \left( {c \in \mathbb{C};{c_0} = {a_0},{c_ + } = \frac{{{a_i} - i{b_i}}}{2},{c_ - } = \frac{{{a_i} + i{b_i}}}{2}} \right)
		\end{split}
	\end{equation}
\end{theorem}
...
\begin{corollary}[Physics - 实数 \& 复数形式的傅里叶级数]
	\begin{equation}\small
		\begin{split}
			\tilde {{\mathbcal E}}(\bm{r},t) &= {{\mathbcal A}_0} + \sum\limits_{i = 1}^\infty  {\left[ {{{\mathbcal A}_i}\cos \left( {\frac{{2\pi }}{\lambda }i\widehat {{{\bm k}_i}} \cdot \bm{r} - \frac{{2\pi }}{T}i \cdot t} \right) + {{\mathbcal B}_i}\sin \left( {\frac{{2\pi }}{\lambda }i\widehat {{{\bm k}_i}} \cdot \bm{r} - \frac{{2\pi }}{T}i \cdot t} \right)} \right]} \\
			&= {{\mathbcal A}_0} + \sum\limits_{i = 1}^\infty  {\left[ {{{\mathbcal A}_i}\cos \left( {{{\bm k}_i} \cdot \bm{r} - {\omega _i}t} \right) + {{\mathbcal B}_i}\sin \left( {{{\bm k}_i} \cdot \bm{r} - {\omega _i}t} \right)} \right]} \\
			&= \sum\limits_{i = 1}^\infty  {{{{\mathbcal C}_i}\cos \left( {{{\bm k}_i} \cdot \bm{r} - {\omega _i}t} - \varphi_i \right)}} \\
			&\left( {\left| A \right|,\left| B \right| \in \mathbb{R};\textnormal{要求\ } {{\mathbcal A}_i}\varparallel {{\mathbcal B}_i}}; \varphi_0 = 0 , {{\mathbcal A}_i} = {{\mathbcal C}_i}\cos \varphi_i, {{\mathbcal B}_i} = {{\mathbcal C}_i}\sin \varphi_i \right) \\
			&= \sum\limits_{i =  - \infty }^\infty  {{{\bm C}_i}{e^{i({{\bm k}_i} \cdot {\bm r} - {\omega _i}t)}}} \\
			&\left( {\left| {\bm C} \right| \in \mathbb{C};{{\bm C}_0} = {{\mathbcal A}_0},{{\bm C}_ + } = \frac{{{{\mathbcal A}_i} - i{{\mathbcal B}_i}}}{2},{{\bm C}_ - } = \frac{{{{\mathbcal A}_i} + i{{\mathbcal B}_i}}}{2}} \right)
		\end{split}
	\end{equation}
\end{corollary}
...
\marginnote[-20em]{
	...
	\begin{equation}
		\begin{split}
			...
			&= \mathop {\sum '}\limits_i {{\bm C}_i}{e^{i({{\bm k}_i} \cdot {\bm r} - {\omega _i}t)}} + {\bm c.c.} \\
			&= \mathop {\sum '}\limits_i \left[ {{C_i}{e^{i({{\bm k}_i} \cdot {\bm r} - {\omega _i}t)}} + {\bm c.c.}} \right] \\
			&= 
		\end{split}
	\end{equation}
}
...
\section{我我我我我我我我我我我我我我我我我我我我我我我我我我我}
